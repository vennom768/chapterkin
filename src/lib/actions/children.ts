...
const childSchema = z.object({
  ...
  hair: z.string().max(80).optional().nullable(),
  eyes: z.string().max(80).optional().nullable(),
  skin: z.string().max(80).optional().nullable(),
  usualClothes: z.string().max(160).optional().nullable(),
